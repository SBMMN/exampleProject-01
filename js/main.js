...
{
  //gsap.to(요소, 시간, 옵션);
  gsap.to(selector, random(1.5,2.5), {y: size, repeat: -1, yoyo: true, ease: "power1.inOut", delay: random(0,delay)});
}
...
const styleEls = document.querySelectorAll('section.scroll-spy');

styleEls.forEach(function(spyEl){
  new ScrollMagic
    .Scene({
